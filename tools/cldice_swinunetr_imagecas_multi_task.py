...
from medseg.loss.skeletonize import Skeletonize
...
def main():
    ...
    cldice = soft_cldice(iter_=3, smooth=1)
    skeletonize = Skeletonize(probabilistic=True, simple_point_detection="Boolean")
    a, b = 0.8, 0.2
    loss_function = lambda y_true, y_pred: a * cldice(y_true, y_pred) + b * skeletonize(y_true, y_pred)  
