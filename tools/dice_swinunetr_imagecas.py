...
from monai.handlers import (CheckpointSaver, EarlyStopHandler,
                            ...
                            MLFlowHandler, ValidationHandler, from_engine)
...
from medseg.core.visualize import render
...
def main():
    ...
    # set hyperparameters
    mlflow_tracking_uri = Path("").as_uri()
    ...
    val_handlers = [
        ...
        MLFlowHandler(tracking_uri=mlflow_tracking_uri, output_transform=lambda x: None),
